...
import test.dy.com.myviewdemo.activity.bai.BaiView.GradationScrollView;
import test.dy.com.myviewdemo.activity.bai.BaiView.MyImageLoader;
import test.dy.com.myviewdemo.activity.bai.BaiView.NoScrollListView;
import test.dy.com.myviewdemo.activity.bai.BaiView.ScrollViewContainer;
import test.dy.com.myviewdemo.activity.bai.BaiView.StatusBarUtil;

public class BaiActivity extends AppCompatActivity implements GradationScrollView.ScrollViewListener{
    ...
    private void initListeners() {
        ...
        vto.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                scrollView.setScrollViewListener((GradationScrollView.ScrollViewListener) BaiActivity.this);
            }
        });
    }
